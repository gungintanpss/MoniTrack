...
export default function DetailPemasukan({ isOpen, onClose, data, onEdit }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-4xl bg-white p-8 rounded-xl shadow-2xl">
        <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">Detail Transaksi</h2>
