...
export default function EditDataTransaksi({ isOpen, onClose, data }: Props) {
  ...
  const kategoriOptions = [
    ...
    { value: "Penerimaan Piutang", label: "Penerimaan Piutang" },
    { value: "Pendanaan Investor", label: "Pendanaan Investor" },
  ];
  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        message="Apakah anda yakin untuk menyimpan perubahan pada transaksi ini?"
        onConfirm={() => {
