          ...
          <Table>
            <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
              <TableRow>
                ...
                <TableCell className="px-5 py-3 font-medium text-start text-theme-xs text-gray-500 dark:text-gray-400">Supplier</TableCell>
                ...
                <TableCell className="px-5 py-3 font-medium text-start text-theme-xs text-gray-500 dark:text-gray-400">Sisa Utang</TableCell>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {currentData.map((item, idx) => (
                <TableRow key={idx}>
                  ...
                  <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">{item.supplier}</TableCell>
          ...
          <div className="rounded-xl bg-white p-6 shadow-2xl w-full max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-sm text-[#3A3F63]">
              <div>
                ...
                <p className="px-4 py-2 bg-gray-100 rounded-md">{selectedData.supplier}</p>
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                <label className="block mb-1 font-medium">Jumlah Utang</label>
                <p className="px-4 py-2 bg-gray-100 rounded-md">{selectedData.jumlah}</p>
              </div>
              <div className="md:col-span-2">
                <label className="block mb-1 font-medium">Sisa Utang</label>
      ...
      {showEdit && selectedData && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
          <div className="bg-white rounded-xl p-6 w-full max-w-4xl shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-sm text-[#3A3F63]">
              <div>
                <label className="block mb-1 text-sm">Nama Supplier</label>
                <Input value={selectedData.supplier} disabled />
              </div>
              <div>
              ...
              <div>
                <label className="block mb-1 text-sm">Diterima dari Rekening/Kas</label>
                <Select
              ...
              <div>
                <label className="block mb-1 text-sm">Sisa Utang</label>
        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-xl p-6 w-full max-w-sm text-center shadow-2xl">
            ...
            <p className="mb-6 text-[#3A3F63]">
              Apakah anda yakin untuk mengubah utang ini?
            </p>
      ...
      {showDeleteConfirm && selectedData && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-xl shadow-xl text-center w-full max-w-sm">
            <h2 className="text-lg font-bold text-[#3A3F63] mb-2">Hapus Utang</h2>
            <p className="text-sm text-gray-600 mb-6">
              Apakah anda yakin untuk menghapus utang ini?
            </p>
